...
% FIXME: SM: I do not understand this link, why do we compare with other open source hardware products, as it seems that until now the arguing is against closed source products?
...
% FIXME: SM: is that in general or only about STEM/programming?
...
% FIXME: SM: The WeDo falls a bit from the sky here, although I see the underlying idea...
...
%The only move in this direction comes from LEGO\textsuperscript{\textregistered}, that made public all the schematics of the EV3 in an hardware developer kit, to allow the design of extensions.
% FIXME: if the LEGO license is not a true open hardware one, I would drop the previous sentence, it does not bring much
...
% FIXME: SM: I would even say that the BeeBot targets a specfic concept for kids, which is the learning of sequences, and is very good at it. I think we could find a strong educational argument to show how limited it is. maybe Morgane can help.
...
% FIXME: SM: I am lacking a link, what is the contribution of the paper in that context?
...
\begin{figure}
   \centering
	...
	%FIXME: SM: maybe we should have a ruler on the side to show the scale?
	\vskip 1.5em
...
% FIXME: SM: what do you mean by specificities here?
...
The behaviors are interactive and oriented toward the user. % SM: FIXME: not clear what "oriented toward the user" means
...
% FIXME: SM: is there a reason to limit images to 90% width?
\begin{figure}
\centering
...
% FIXME: SM: "many royalties" is unclear
...
% FIXME: SM: duplication about "our team"
...
% FIXME: SM: I do not understand the dots
...
% FIXME: SM: in case of lack of space, we can strip this paragraph away
...
%FIXME: SM: what do you mean by "ported several educational materials into their curriculum", which direction?
...
% FIXME: SM: I do not totally agree, successful open source software project are heavily engineering-oriented, maybe it is interesting to highlight the effect of hardware here
...
% FIXME: SM: I would highlight the problem of sustained funding
...
% FIXME: SM: it is not clear what you mean by "performances" in the following sentence
...
% FIXME: SM: I do not totally agree, Mindstorms was very successful in schools in the US, our paper is kind of weak with respect to such work
...
% FIXME: SM: although I see what you want to say, I feel that the gender issue falls a bit from the sky here
